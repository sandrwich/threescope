<script lang="ts">
  ...
  import { ICON_HELP } from './shared/icons';
</script>

{#snippet helpIcon()}<span class="title-icon">{@html ICON_HELP}</span>{/snippet}

<DraggableWindow title="Help" icon={helpIcon} modal bind:open={uiStore.infoModalOpen}>
